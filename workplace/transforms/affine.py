...
thermal_aligned_save_path = os.path.join(vis_dir, 'thermal_aligned_affine.png')
thermal_rgb_overlay_save_path = os.path.join(vis_dir, 'thermal_rgb_overlay_affine.png')
...
if __name__ == '__main__':
    if use_existing_matrix:
        ...
        # 计算仿射变换矩阵
        M = compute_matrix_from_pts(PTS_THERMAL, PTS_RGB)
    ...
    thermal_aligned = cv2.warpAffine(thermal_img, M, (w, h))
